...
eval_one_language() {
    ...
    base_output="${eval_root}/qwen3_8b_base_${lang_lower}_max${MAX_NEW_TOKENS}_valn${VAL_N}.json"
    ...
    for step in "${CHECKPOINT_STEPS[@]}"; do
        ...
        ckpt_output="${eval_root}/qwen3_8b_opsd_${lang_lower}_step${step}_max${MAX_NEW_TOKENS}_valn${VAL_N}.json"
